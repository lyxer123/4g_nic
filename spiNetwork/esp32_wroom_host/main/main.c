...
// SPI引脚配置
#define SPI_MOSI_PIN        23      // 主机输出
#define SPI_MISO_PIN        19      // 主机输入
#define SPI_CLK_PIN         18      // 时钟输出
#define SPI_CS_PIN          5       // 片选输出
#define SPI_HANDSHAKE_PIN   4       // 从机握手信号 (输入)
#define SPI_DATA_READY_PIN  2       // 从机数据就绪 (输入)
